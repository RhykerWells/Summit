...
var (
	economyConfigAllColumns            = []string{"guild_id", "economy_enabled", "economy_symbol", "economy_start_balance", "economy_min_return", "economy_max_return", "economy_max_bet", "economy_custom_work_responses_enabled", "economy_custom_crime_responses_enabled"}
	economyConfigColumnsWithoutDefault = []string{"guild_id"}
	economyConfigColumnsWithDefault    = []string{"economy_enabled", "economy_symbol", "economy_start_balance", "economy_min_return", "economy_max_return", "economy_max_bet", "economy_custom_work_responses_enabled", "economy_custom_crime_responses_enabled"}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (economyConfigL) LoadGuildEconomyResponses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEconomyConfig interface{}, mods queries.Applicator) error {
	var slice []*EconomyConfig
	var object *EconomyConfig
