...
func (economyUserL) LoadGuild(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEconomyUser any, mods queries.Applicator) error {
...
func (o *EconomyUser) SetGuild(ctx context.Context, exec boil.ContextExecutor, insert bool, related *EconomyConfig) error {
	...
	values := []any{related.GuildID, o.GuildID, o.UserID}
